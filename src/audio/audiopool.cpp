...
void AudioPool::load()
{
	try {
		...
		sample[AudioClip::scarabeus1].load("res/audio/scarabeus1.ogg");
		sample[AudioClip::scarabeus2].load("res/audio/scarabeus2.ogg");
		sample[AudioClip::scarabeus3].load("res/audio/scarabeus3.ogg");
		sample[AudioClip::scarabeus4].load("res/audio/scarabeus4.ogg");
		sample[AudioClip::scarabeus5].load("res/audio/scarabeus5.ogg");
		sample[AudioClip::scarabeus6].load("res/audio/scarabeus6.ogg");
		sample[AudioClip::scarabeus7].load("res/audio/scarabeus7.ogg");
		sample[AudioClip::scarabeus8].load("res/audio/scarabeus8.ogg");
		sample[AudioClip::scarabeus9].load("res/audio/scarabeus9.ogg");
