...
: ppl7::tk::Frame(x,y,width,height)
{
	...
	layer0=new RadioButton(60,35,50,20,"0", true);
	this->addChild(layer0);

	layer1=new RadioButton(110,35,50,20,"1");
...
void TilesSelection::setTileSet(int id, const ppl7::String &name, Sprite *sprites)
{
	if (id<1 || id>MAX_TILESETS) return;
	tilesets[id]=sprites;
	tilesetName[id]=name;
